          ...
          <section id="mission" className="glass-card p-6 md:p-10">
            ...
            <div className="bg-gray-100/50 dark:bg-gray-800/50 p-8 rounded-lg border border-gray-200 dark:border-gray-700 shadow-inner">
              ...
              <p className="text-lg leading-relaxed">
                <strong className="text-emerald-700 dark:text-emerald-400">Community First:</strong> This Hub is a community-driven project, created for the love of music and AI exploration, <strong>not for financial gain</strong>. We always strive to link back to the original source pages (e.g., Suno.com, FlowMusic.app) and ensure credit goes to the creators.
              </p>
            </div>
          </section>

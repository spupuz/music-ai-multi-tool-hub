                    ...
                    {block.lyrics.map((lyric, lyricIndex) => (
                        <div key={lyric.id} className="flex items-center gap-3 group/lyric bg-white dark:bg-black/10 p-1.5 rounded-xl border border-transparent hover:border-gray-200 dark:hover:border-white/5 transition-all">
                            ...
                            <div className="flex items-center opacity-0 group-hover/lyric:opacity-100 transition-all gap-0.5 pr-1">
                                <Button onClick={() => onReorderLyricLine(block.id, lyricIndex, 'up')} aria-label="Move Up" disabled={lyricIndex === 0} variant="ghost" size="xs" className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 disabled:opacity-20 border-none shadow-none transition-colors" title="Move Up" startIcon={<UpArrowIcon className="w-3 h-3" />} />
                                <Button onClick={() => onReorderLyricLine(block.id, lyricIndex, 'down')} aria-label="Move Down" disabled={lyricIndex === block.lyrics.length - 1} variant="ghost" size="xs" className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 disabled:opacity-20 border-none shadow-none transition-colors" title="Move Down" startIcon={<DownArrowIcon className="w-3 h-3" />} />

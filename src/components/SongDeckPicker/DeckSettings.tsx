                ...
                <div className="space-y-2">
                    <details className="bg-white/5 dark:bg-black/20 p-3 rounded-xl border border-white/10 dark:border-black/20 shadow-inner group transition-all">
                        ...
                        <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 p-1">
                            <div><label className="block text-xs font-bold mb-1 opacity-80" style={{color:props.toolTextColor}}>Tool Background</label><div className="flex items-center gap-1"><input type="color" aria-label="Tool Background Color" value={props.toolBackgroundColor} onChange={(e) => props.setCardBackgroundColor(e.target.value)} className="p-0 h-9 w-10 rounded border-gray-300 dark:border-gray-600 cursor-pointer bg-white dark:bg-gray-700 shadow-sm"/><InputField id="toolBgColorHex" label="" value={props.toolBackgroundColorHexInput} onChange={props.handleToolBgColorHexChange} className="mb-0 flex-grow" type="text"/></div></div>
                            <div><label className="block text-xs font-bold mb-1 opacity-80" style={{color:props.toolTextColor}}>Tool Accent</label><div className="flex items-center gap-1"><input type="color" aria-label="Tool Accent Color" value={props.toolAccentColor} onChange={(e) => props.setCardBackgroundColor(e.target.value)} className="p-0 h-9 w-10 rounded border-gray-300 dark:border-gray-600 cursor-pointer bg-white dark:bg-gray-700 shadow-sm"/><InputField id="toolAccentColorHex" label="" value={props.toolAccentColorHexInput} onChange={props.handleToolAccentColorHexChange} className="mb-0 flex-grow" type="text"/></div></div>
                            <div><label className="block text-xs font-bold mb-1 opacity-80" style={{color:props.toolTextColor}}>Tool Text</label><div className="flex items-center gap-1"><input type="color" aria-label="Tool Text Color" value={props.toolTextColor} onChange={(e) => props.setCardBackgroundColor(e.target.value)} className="p-0 h-9 w-10 rounded border-gray-300 dark:border-gray-600 cursor-pointer bg-white dark:bg-gray-700 shadow-sm"/><InputField id="toolTextColorHex" label="" value={props.toolTextColorHexInput} onChange={props.handleToolTextColorHexChange} className="mb-0 flex-grow" type="text"/></div></div>
                            ...
                            <div><label className="block text-xs font-bold mb-1 opacity-80" style={{color:props.toolTextColor}}>Card Background</label><div className="flex items-center gap-1"><input type="color" aria-label="Card Background Color" value={props.cardBackgroundColor} onChange={(e) => props.setCardBackgroundColor(e.target.value)} className="p-0 h-9 w-10 rounded border-gray-300 dark:border-gray-600 cursor-pointer bg-white dark:bg-gray-700 shadow-sm"/><InputField id="cardBgColorHex" label="" value={props.cardBackgroundColorHexInput} onChange={props.handleCardBgColorHexChange} className="mb-0 flex-grow" type="text"/></div></div>
                            <div><label className="block text-xs font-bold mb-1 opacity-80" style={{color:props.toolTextColor}}>Card Border</label><div className="flex items-center gap-1"><input type="color" aria-label="Card Border Color" value={props.cardBorderColor} onChange={(e) => props.setCardBorderColor(e.target.value)} className="p-0 h-9 w-10 rounded border-gray-300 dark:border-gray-600 cursor-pointer bg-white dark:bg-gray-700 shadow-sm"/><InputField id="cardBorderColorHex" label="" value={props.cardBorderColorHexInput} onChange={props.handleCardBorderColorHexChange} className="mb-0 flex-grow" type="text"/></div></div>
                            <div><label className="block text-xs font-bold mb-1 opacity-80" style={{color:props.toolTextColor}}>Card Text (Preferred)</label><div className="flex items-center gap-1"><input type="color" aria-label="Card Text Color" value={props.cardTextColor} onChange={(e) => props.setCardTextColor(e.target.value)} className="p-0 h-9 w-10 rounded border-gray-300 dark:border-gray-600 cursor-pointer bg-white dark:bg-gray-700 shadow-sm"/><InputField id="cardTextColorHex" label="" value={props.cardTextColorHexInput} onChange={props.handleCardTextColorHexChange} className="mb-0 flex-grow" type="text"/></div></div>

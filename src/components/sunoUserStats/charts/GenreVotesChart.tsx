...
interface GenreVotesChartProps {
  data: GenreStat[];
...
const GenreVotesChart: React.FC<GenreVotesChartProps> = ({ 
  data, 
  barColorStart = '#FFF3E0',
  barColorEnd = '#E65100',
  fontColor = '#e5e7eb',
  gridColor = '#374151',
  topN = 10, 
  ...
  return <canvas ref={chartRef} aria-label="Genre Votes Chart"></canvas>;
};

export default GenreVotesChart;
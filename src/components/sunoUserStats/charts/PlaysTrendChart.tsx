...
interface PlaysTrendChartProps {
...
const PlaysTrendChart: React.FC<PlaysTrendChartProps> = ({ 
  data, 
  lineColor = '#44ff44', // Default Green
  fontColor = '#e5e7eb',
  gridColor = '#374151',
}) => {
  ...
  if (!data || data.length === 0) {
    return <p className="text-center text-gray-500 text-sm italic py-4">No data available for plays trend.</p>;
  }

  return <canvas ref={chartRef} aria-label="Plays Trend Chart"></canvas>;
};

export default PlaysTrendChart;
      ...
      {detail.user_id !== "custom_list_synthetic_id" && detail.image_url && (
        <div className="relative flex-shrink-0 group/avatar">
          ...
          <img 
            ...
            loading="lazy"
            decoding="async"
            className="w-32 h-32 sm:w-40 sm:h-40 rounded-full object-cover border-4 border-gray-200 dark:border-white/10 shadow-2xl relative z-10 grayscale-[0.2] group-hover/avatar:grayscale-0 transition-all duration-500" 
          />
        </div>
      )} 
    ...
    <div className="mb-10 glass-card p-6 sm:p-8 flex flex-col md:flex-row items-center md:items-start gap-8 relative overflow-hidden group">
      ...
      <div className="relative flex-shrink-0 group/cover">
        ...
        <img 
          ...
          loading="lazy"
          decoding="async"
          className="w-32 h-32 sm:w-40 sm:h-40 rounded-2xl object-cover border-4 border-gray-200 dark:border-white/10 shadow-2xl relative z-10 grayscale-[0.2] group-hover/cover:grayscale-0 transition-all duration-500" 
        />
      </div> 
      <div className="flex-1 text-center md:text-left min-w-0 z-10"> 

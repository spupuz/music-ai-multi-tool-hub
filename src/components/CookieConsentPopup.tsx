      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex-shrink-0 flex gap-3 mt-4 md:mt-0">
          <Button
            ...
            variant="ghost"
            size="md"
            className="px-6 py-2.5 text-xs font-black uppercase tracking-widest text-green-700 dark:text-green-300 border-green-600 dark:border-green-500 hover:bg-green-600/10"

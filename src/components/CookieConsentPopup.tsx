...
const CookieConsentPopup: React.FC<CookieConsentPopupProps> = ({ onAccept, onLearnMore }) => {
  return (
    <div 
      className="fixed bottom-0 left-0 right-0 glass-card border-none rounded-none border-t border-gray-200 dark:border-white/10 shadow-[0_-20px_50px_rgba(0,0,0,0.5)] z-[100] p-4 md:p-6 text-gray-800 dark:text-gray-200 transition-colors duration-300"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex-grow">
          <h2 id="cookie-consent-title" className="text-lg font-black uppercase tracking-tight text-emerald-500 mb-1">
          ...
          <p id="cookie-consent-description" className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            Please review our <Button onClick={onLearnMore} variant="ghost" className="inline-flex h-auto p-0 text-emerald-500 hover:text-emerald-400 underline font-black uppercase tracking-widest text-[10px] bg-transparent border-none shadow-none">Privacy Policy</Button> for full details.
          </p>
        </div>
        <div className="flex-shrink-0 flex gap-3 mt-4 md:mt-0">
          <Button
            ...
            variant="ghost"
            size="md"
            className="px-6 py-2.5 text-xs font-black uppercase tracking-widest text-emerald-500 border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/10"

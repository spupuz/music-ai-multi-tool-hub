      ...
      {showImportExportModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[100] p-4 animate-in fade-in duration-300">
          <div className="glass-card p-10 max-w-md w-full border-gray-200 dark:border-white/10 shadow-2xl relative overflow-hidden">
            ...
            <div className="space-y-6">
              <Button onClick={handleExportPresets} disabled={savedArtStylePresets.length === 0} title={savedArtStylePresets.length === 0 ? "No presets to export" : undefined} variant="primary" size="sm" className="w-full font-black uppercase tracking-widest text-[9px] py-4 rounded-2xl shadow-purple-500/10" backgroundColor="#8b5cf6">

...
const Button: React.FC<ButtonProps> = ({
    ...
    const sizeStyles = {
        xs: 'px-3 py-1 text-[8px] gap-1',
        sm: 'px-3 py-1 md:px-4 md:py-1.5 text-[9px] gap-1.5',
        md: 'px-4 py-2.5 sm:px-5 text-[10px] gap-2',
        lg: 'px-3 py-2.5 sm:px-8 sm:py-4 text-xs gap-3',
    };

    // Variant Styles - Premium gradients for Architect
    const variantStyles = {
        ...
        ghost: 'bg-transparent hover:bg-slate-100 dark:hover:bg-white/5 text-slate-700 dark:text-slate-300 shadow-none border-white/5 ring-0 outline-none focus:ring-0 focus:outline-none',
        outline: 'bg-transparent border border-white/10 hover:border-white/20 text-slate-700 dark:text-slate-300 shadow-none',
    };

...
### Changed
- **About page performance**: `AboutPage.tsx` now memoizes the category-based tool grouping with `useMemo`, preventing redundant `reduce` work on every re-render and matching the existing `Sidebar.tsx` pattern.

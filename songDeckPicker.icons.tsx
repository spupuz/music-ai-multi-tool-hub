// songDeckPicker.icons.tsx
import React from 'react';

export const EyeOpenIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
...
export const DiceFiveIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => ( 
...
export const PlusCircleIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-1.5" }) => ( 
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ConfigIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const SaveIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-1.5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const LoadDeckIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-1.5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
    </svg>
);
export const DeleteIcon: React.FC<{ className?: string }> = ({ className = "w-3 h-3" }) => (
...
export const ExportIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-1.5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75v6.75m0 0l-3-3m3 3l3-3m-8.25 6a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" />
    </svg>
);
export const ImportIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4 mr-1.5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" />
    </svg>
);

export const ArrowDownIcon: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className = "w-8 h-8", style }) => ( 
...
export const HandRaisedIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => ( // Simple Checkmark Icon
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const FolderPlusIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>

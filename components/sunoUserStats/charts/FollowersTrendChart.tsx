...
const FollowersTrendChart: React.FC<FollowersTrendChartProps> = ({ 
  data, 
  lineColor = '#4444ff', // Default Blue
  fontColor = '#e5e7eb',
  gridColor = '#374151',
}) => {
  ...
  if (!data || data.length === 0) {
    return <p className="text-center text-gray-500 text-sm italic py-4">No data available for followers trend.</p>;
  }

  return <canvas ref={chartRef} aria-label="Followers Trend Chart"></canvas>;
};
